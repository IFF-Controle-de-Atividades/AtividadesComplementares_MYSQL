...
def inserindo_administrador
 	Avaliador.create(nome: 'Administrador', sexo: 'Masculino', titulacao: 'Alterar sua titulação', matricula: 'Altere depois' ,email: 'admin@admin.com', password: 'admin', admin: 1, status: 1)
end	
